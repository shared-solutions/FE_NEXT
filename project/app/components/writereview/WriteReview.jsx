          ...
          <WriteReviewHeader title={title} content={content} />
            <div className={styles.content_footer_container}>
              ...
              <div className={styles.content_container}>
                <input className={styles.title} type="text" placeholder="제목" onChange={(e) => setTitle(e.target.value)}/>
                          ...
                          <div className={styles.pull_review_container}>
                            ...
                            <div className={styles.footer}>
                              <div className={styles.like}>
                                <Image src={likeimg} alt="좋아요" width={15} height={13} /> {selectedBoxData.like}
                              </div>
                              <div className={styles.comment}>
                                <Image src={commentimg} alt="댓글" width={15} height={13} /> {selectedBoxData.comment}
                              </div>
                            </div>
                          </div>
                        </div>
