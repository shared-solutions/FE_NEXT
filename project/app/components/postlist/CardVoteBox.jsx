        ...
        <div className={styles.imgSlide}>
          {pollOption &&
            pollOption.map((option, index) => {
              ...
              const topCandidateIds = topCandidate.map(candidate => candidate.optionId);
              ...
              return (
                ...
                > 
                  <div style={{position: "absolute", top: "7px", left: "10px", fontWeight: "bold"}}>{option.optionString}</div>
                  {option.optionImgUrl && (
                    <Image
